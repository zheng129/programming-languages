...
- you are interested in the [history of PLs](https://en.wikipedia.org/wiki/History_of_programming_languages) 
  - Fortran, Lisp, Algol, Simula,... are some old languages (1957-1967) that are not mainstream anymore but still influential because they lead to languages such as  
